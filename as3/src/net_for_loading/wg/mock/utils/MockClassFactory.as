package net_for_loading.wg.mock.utils
{
    ...
    public class MockClassFactory implements IClassFactory
    {
        ...
        public function getComponent(param1:String, param2:Class, param3:Object = null, param4:LoaderInfo = null) : *
        {
            ...
            var _loc6_:*;
            var _loc7_:* = (_loc6_ = "object with \"" + param1 + "\" linkage ") + "is not a component from library!";
            var _loc8_:String = _loc6_ + "can`t cast to " + param2;
            var _loc9_:IAssertable;
            (_loc9_ = App.utils.asserter).assert(_loc5_ is DisplayObject,_loc7_,InvalidComponentCastException);
        ...
        public function getObject(param1:String, param2:Object = null, param3:LoaderInfo = null) : Object
        {
            ...
            var _loc5_:Class;
            if((_loc5_ = this.getClass(param1)) != null)
            {
                _loc4_ = new _loc5_();
                if(param2 != null)
                {
