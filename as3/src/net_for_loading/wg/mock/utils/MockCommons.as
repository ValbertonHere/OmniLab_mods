package net.wg.mock.utils
{
    ...
    public class MockCommons implements ICommons
    {
        ...
        public function setBlur(param1:DisplayObject, param2:Number = 4, param3:Number = 4, param4:int = 1) : void
        {
        }
        ...
        public function setShadowFilterWithParams(param1:DisplayObject, param2:Number = 4, param3:Number = 45, param4:uint = 0, param5:Number = 1, param6:Number = 4, param7:Number = 4, param8:Number = 1, param9:int = 1, param10:Boolean = false, param11:Boolean = false, param12:Boolean = false) : void
        {
        }
