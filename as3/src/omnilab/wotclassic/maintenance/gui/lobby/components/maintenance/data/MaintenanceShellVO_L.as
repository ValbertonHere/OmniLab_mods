package omnilab.wotclassic.maintenance.gui.lobby.components.maintenance.data
{
    ...
    public class MaintenanceShellVO_L extends ShellButtonVO
    {
        ...
        public function MaintenanceShellVO_L(param1:Object)
        {
            super(param1);
        }
        ...
        public function updateUserCount() : void
        {
            ...
            var _loc4_:int = (_loc4_ = _loc2_ - this.maxAmmo) > 0 ? _loc4_ : 0;
