package omnilab.wotclassic.maintenance.gui.lobby.hangar.maintenance
{
    ...
    public class EquipmentItem extends SoundButtonEx
    {
        ...
        override protected function showTooltip() : void
        {
            ...
            if(_loc1_)
            {
                App.toolTipMgr.showSpecial(TOOLTIPS_CONSTANTS.TECH_MAIN_MODULE,null,_loc1_.id,_loc1_.slotIndex);
            }
            else
            {
        ...
        public function setData(param1:Array, param2:int, param3:Array, param4:Array) : void
        {
            ...
            if(Boolean(this._setupItem) && this._setupItem.builtIn)
            {
        ...
        private function update() : void
        {
            ...
            this.price.visible = !_loc1_.isInstalled || !_loc1_.isInInventory;
            ...
            if(_loc5_ = Currencies.checkSeveralPrices(_loc1_.prices))
            {
        ...
        {
            this.toBuyTf.visible = false;
            this.moduleType.moduleIcon.source = "../" + "maps/icons/moduleTypes/" + EMPTY_LABEL + ".png";
            this.slotOverlay.visible = false;
        ...
        private function updateModulePrice() : void
        {
            ...
            var _loc2_:int = 0;
            var _loc3_:int = 0;
            this.toBuy.icon = _loc1_.currency;
            if(_loc1_.inventoryCount == 0 && this.changed && this._installedData.indexOf(_loc1_.compactDescr) == -1)
            {
                _loc2_ = 1;
            }
            _loc3_ = int(_loc1_.prices[_loc1_.currency == CURRENCIES_CONSTANTS.CREDITS ? 0 : 1]);
            var _loc4_:ILocale = App.utils.locale;
			...
			var itemPrices:ItemPriceVO  = _loc2_ != 0 ? _loc1_.itemPrices[0] : _loc1_.nullItemPrices[0];
            this.price.setData(itemPrices);
            this.toBuy.text = _loc2_ + MULTY_CHARS + App.utils.locale.integer(_loc1_.itemPrices[0].price.getPriceVO().value);
            this.toBuyTf.text = _loc2_ + MULTY_CHARS;
            this.toBuy.enabled = _loc2_ != 0;
            ...
            this.toBuyTf.alpha = this.price.alpha = _loc2_ != 0 ? 1 : 0.3;
        }
        ...
        {
            if(Boolean(this._slotArtifacts) && this.select.selectedIndex != -1)
            {
        ...
        override protected function onMouseDownHandler(param1:MouseEvent) : void
        {
            ...
            if(Boolean(this.selectedItem) && param1 is MouseEventEx)
            {
        ...
        private function onSelectIndexChangeHandler(param1:ListEvent) : void
        {
            ...
            if(Boolean(this.selectedItem) && this.selectedItem.inSetup)
            {
        ...
        public function selectByItemId(param1:String) : void
        {
            ...
            var success:Boolean = Boolean(this._slotArtifacts) && this._slotArtifacts.some(function(param1:ModuleVO, param2:int):Boolean
            {
                if(param1.id == itemId)
                {
