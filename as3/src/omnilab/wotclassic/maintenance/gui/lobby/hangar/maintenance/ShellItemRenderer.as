package omnilab.wotclassic.maintenance.gui.lobby.hangar.maintenance
{
    ...
    public class ShellItemRenderer extends SoundListItemRenderer
    {
            ...
            if(isInvalid(InvalidationType.DATA))
            {
                ...
                if(this._rendererData != null)
                {
                    ...
                    if(_loc1_)
                    {
                        ...
                        {
                            (_loc4_ = new ActionPriceVO(this._rendererData.actionPriceData)).forCredits = this._rendererData.currency == CURRENCIES_CONSTANTS.CREDITS;
                        }
                    ...
                    this.clearChangeableShells();
                    _loc2_ = int(this._rendererData.list.length);
        ...
        private function clearChangeableShells() : void
        {
            ...
            {
                _loc1_ = int(this._changeableShellsList.length);
                _loc2_ = 0;
                while(_loc2_ < _loc1_)
                {
        ...
        private function updateShellsPrice() : void
        {
            ...
            _loc2_ = int(this._rendererData.prices[Currencies.INDEX_FROM_NAME[_loc5_]]);
            ...
            if(this._rendererData.actionPriceData)
            {
                (_loc8_ = new ActionPriceVO(this._rendererData.actionPriceData)).forCredits = _loc5_ == CURRENCIES_CONSTANTS.CREDITS;
