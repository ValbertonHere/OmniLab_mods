package omnilab.wotclassic.maintenance.gui.lobby.hangar.maintenance
{
    ...
    import omnilab.wotclassic.maintenance.gui.lobby.components.maintenance.data.MaintenanceVO;
    ...
    import omnilab.wotclassic.maintenance.infrastructure.base.meta.ITechnicalMaintenanceMeta;
    import omnilab.wotclassic.maintenance.infrastructure.base.meta.impl.TechnicalMaintenanceMeta;
    ...
    public class TechnicalMaintenance extends TechnicalMaintenanceMeta implements ITechnicalMaintenanceMeta
    {
        ...
        private var _currentLayoutCapacity:uint = 3;
        ...
        {
            super.draw();
            if(Boolean(this._maintenanceData) && isInvalid(InvalidationType.DATA))
            {
            ...
            {
                this.updateEquipmentBlock(this._equipmentInstalled,this._equipmentSetup,this._equipmentList, this._currentLayoutCapacity);
            }
        ...
        override protected function setEquipment(param1:Array, param2:Array, param3:Array, param4:uint) : void
        {
            this._equipmentList = param3;
            this._equipmentSetup = param2;
            this._equipmentInstalled = param1;
			this._currentLayoutCapacity = param4;
        ...
        public function as_setEquipmentVisible(param1: Array) : void
        {
			var _loc1_: Boolean = !param1[0] && !param1[1] && !param1[2];
			
            this.eqItem1.visible = param1[0]
			this.eqItem2.visible = param1[1]
			this.eqItem3.visible = param1[2]
			this.eqAuto.enabled = !_loc1_;
            this.eqIndicator.flashing = _loc1_;
			this.eqIndicator.maximum = this._currentLayoutCapacity;
            this.eqLabelDisabled.visible = _loc1_;
			
			if (this._currentLayoutCapacity == 0) {
				this.shellsIndicator.textField.text = "0/0";
			}
        }
        ...
        private function updateEquipmentBlock(param1:Array, param2:Array, param3:Array, param4:uint) : void
        {
            ...
            var _loc7_:int = int((_loc5_ = [this.eqItem1,this.eqItem2,this.eqItem3]).length);
            ...
            while(_loc12_ < _loc7_)
            {
                ...
                if(_loc12_ > 0)
                {
                    ...
                    {
                        (_loc9_ = new ModuleVO(param3[_loc4_].toHash())).slotIndex = _loc12_;
                        _loc9_.userCredits = {
                            "credits":this._maintenanceData.credits,
                            "gold":this._maintenanceData.gold
                        };
                ...
                if(!this._isApplyEnable && Boolean(_loc6_.selectedItem))
                {
            ...
            this.eqIndicator.maximum = param4;
            this.eqIndicator.value = _loc11_;
            this.eqIndicator.setDivisor(_loc11_, param4);
            this.eqIndicator.textField.text = _loc11_ + SPLITTER_CHAR + this._currentLayoutCapacity;
        }
        ...
        private function updateButtonStates() : void
        {
            ...
            this.eqIndicator.label = _loc3_ + SPLITTER_CHAR + this._currentLayoutCapacity;
        ...
        private function __getAmmoPrice() : Prices
        {
            ...
            for each(_loc2_ in this._maintenanceData.shells)
            {
                _loc1_[_loc2_.currency] += _loc2_.buyShellsCount * _loc2_.price;
            }
            return _loc1_;
        }
        ...
        private function __getEquipmentsPrice() : Prices
        {
            ...
            for each(_loc3_ in _loc2_)
            {
                ...
                {
                    _loc1_[_loc3_.selectedItem.currency] += _loc3_.selectedItem.itemPrices[0].price.getPriceVO().value;
                }
            }
            return _loc1_;
        }
        ...
        private function onModuleOnEquipmentRendererOverHandler(param1:OnEquipmentRendererOver) : void
        {
            ...
            this._toolTipMgr.showSpecial(TOOLTIPS_CONSTANTS.PREVIEW_MODULE,null,param1.moduleID,param1.moduleIndex);
        }
        ...
        private function onAutoRollOverHandler(param1:MouseEvent) : void
        {
            ...
            {
                _loc2_ = "#wek:technicalMaintenance/repair/auto";
            }
            else if(param1.target == this.shellsAuto)
            {
                _loc2_ = "#wek:technicalMaintenance/ammo/auto";
            }
            else if(param1.target == this.eqAuto)
            {
                _loc2_ = "#wek:technicalMaintenance/equipment/auto";
            }
            if(_loc2_)
            {
        ...
        private function onApplyBtnClickHandler(param1:ButtonEvent) : void
        {
            ...
            _loc7_ = (_loc6_ = this.__getAmmoPrice()).credits > 0 || _loc6_.gold > 0;
            _loc9_ = (_loc8_ = this.__getEquipmentsPrice()).credits > 0 || _loc8_.gold > 0;
...
class Prices
{
    ...
    public function Prices(param1:Number = 0, param2:Number = 0, param3:Number = 0)
    {
        super();
        this.credits = param1;
        this.gold = param2;
