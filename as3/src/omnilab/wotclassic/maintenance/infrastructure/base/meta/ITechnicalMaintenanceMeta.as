package omnilab.wotclassic.maintenance.infrastructure.base.meta
{
    ...
    public interface ITechnicalMaintenanceMeta extends IEventDispatcher
    {
        ...
        function getEquipmentS(param1:String, param2:String, param3:String, param4:String, param5:String, param6:String) : void;
        ...
        function as_setEquipment(param1:Array, param2:Array, param3:Array, param4:uint) : void;
        ...
        function as_setEquipmentVisible(param1:Array) : void;
    }
}
