package omnilab.wotclassic.maintenance.infrastructure.base.meta.impl
{
    ...
    public class TechnicalMaintenanceMeta extends AbstractWindowView
    {
        ...
        final public function as_setEquipment(param1:Array, param2:Array, param3:Array, param4:uint) : void
        {
            ...
            this.setEquipment(this._array2,this._array3,this._arrayModuleVO, param4);
            if(_loc4_)
            {
        ...
        protected function setEquipment(param1:Array, param2:Array, param3:Array, param4:uint) : void
        {
